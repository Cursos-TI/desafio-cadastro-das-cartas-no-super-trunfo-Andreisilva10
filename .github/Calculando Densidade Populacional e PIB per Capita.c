...
int main(){
    ...
    densidade_populacional_1 = populacao_1 / area_em_km_1;
    ...
    printf("Densidade_populacional_1: %f\n", densidade_populacional_1);
    printf("Pib_per_capita_1: %f\n\n", pib_per_capita_1);
    ...
    printf("Numero_de_pontos_turisticos: %d\n", numero_de_pontos_turisticos_2);
     printf("Densidade_populacional_2: %f\n", densidade_populacional_2);
    printf("Pib_per_capita_2: %f\n\n", pib_per_capita_2);
